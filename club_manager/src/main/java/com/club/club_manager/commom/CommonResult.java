...
public class CommonResult<T> implements Serializable {
    ...
    public CommonResult(RetCode code, String msg, T data) {
        this.code = code;
        this.msg = msg;
        this.data = data;
    }
    ...
    public static <T> CommonResult<T> succeed(String msg, T data) {
        return succeed(RetCode.SUCCESS, msg, data);
    }

    public static <T> CommonResult<T> succeed(RetCode code, String msg, T data) {
    ...
    public static <T> CommonResult<T> failed(RetCode code, String msg, T data) {
        return new CommonResult<T>(code, msg, data);
    }
    ...
    public static <T> CommonResult<T> validateFailed(String msg) {
        return new CommonResult<T>(RetCode.VALIDATE_FAILED, msg, null);
    }

    public static <T> CommonResult<T> validateFailed(BindingResult result) {
